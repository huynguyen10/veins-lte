...
class TraCICommandInterface
{
	public:
		...
		//************* Quang-Huy Nguyen *******************
		// Person methods
		bool addPerson(std::string personId, std::string personTypeId, std::string edgeId, simtime_t emitTime_st = -DEPART_NOW, double emitPosition = -DEPART_POS_BASE);
		class Person {
		public:
		...
		// Edge methods
		std::list<std::string> getEdgeIds();
