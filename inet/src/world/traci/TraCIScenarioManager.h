...
class INET_API TraCIScenarioManager : public cSimpleModule
{
    public:
        ...
        void commandSetSpeed(int objectType, std::string nodeId, double speed);
    ...
    protected:
        ...
        std::string moduleType; /**< module type to be used in the simulation for each managed vehicle/person */
        std::string moduleName; /**< module name to be used in the simulation for each managed vehicle/person */
        std::string moduleDisplayString; /**< module displayString to be used in the simulation for each managed vehicle/person */
        std::string host;
        int port;
        ...
        uint32_t activePersonCount; /**< number of persons reported as active by TraCI server */
        //**************************************************
