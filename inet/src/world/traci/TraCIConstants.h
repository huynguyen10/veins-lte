...
//************* Quang-Huy Nguyen *******************
// current person number (get: person)
#define VAR_PERSON_NUMBER 0x67

// command: get person variable (174)
#define CMD_GET_PERSON_VARIABLE 0xae

// command: set person variable (206)
#define CMD_SET_PERSON_VARIABLE 0xce

// command: subscribe person context(142)
#define CMD_SUBSCRIBE_PERSON_CONTEXT 0x8e

// command: subscribe person variable (222)
#define CMD_SUBSCRIBE_PERSON_VARIABLE 0xde

// last step person id list (26)
#define LAST_STEP_PERSON_ID_LIST 0x1a

// response: get person variable (190)
#define RESPONSE_GET_PERSON_VARIABLE 0xbe

// response: subscribe person context (158)
#define RESPONSE_SUBSCRIBE_PERSON_CONTEXT 0x9e

// response: subscribe person variable (238)
